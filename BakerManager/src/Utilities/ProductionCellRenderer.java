 ...
 */
public class ProductionCellRenderer extends DefaultTableCellRenderer {

    private final int color_column;

    public ProductionCellRenderer(int column) {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean focused, int row, int column) {
        ...
        ProduccionCabeceraTableModel tm = (ProduccionCabeceraTableModel) table.getModel();
