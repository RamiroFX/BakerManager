 ...
 */
public class CobroClienteStatusCellRenderer extends DefaultTableCellRenderer {

    private List<E_cuentaCorrienteCabecera> list;

    public CobroClienteStatusCellRenderer(List<E_cuentaCorrienteCabecera> list) {
        this.list = list;
    }

    public void setList(List<E_cuentaCorrienteCabecera> list) {
        this.list = list;
    }
