 ...
 */
public class V_crearPlantillaVenta extends javax.swing.JDialog {

    private final String paperHint = "A4(595 x 842)pixels";
    public javax.swing.JButton jbAceptar, jbCancelar, jbAgregarCampo, jbModificarCampo,
    ...
    public JTextField jtfNombre, jtfTipoLetra, jtfDistanciaEntreCopias;
    ...
    public V_crearPlantillaVenta(javax.swing.JDialog dialog) {
        super(dialog, true);
