 ...
 */
public class V_gestionNotasCredito extends JDialog {
    ...
    private void initTop() {
        ...
        jpFiltros.add(new JLabel("Nro. Nota crédito:"));
        ...
        jbBuscar.setName("buscar notas credito");
    ...
    private void initBot() {
        jpBot = new JPanel();
        jbNueva = new JButton("Crear nota de crédito");
