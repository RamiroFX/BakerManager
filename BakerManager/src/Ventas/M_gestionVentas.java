...
public class M_gestionVentas {
    ...
    public void obtenerVentas(M_cliente cliente, M_funcionario funcionario, Date fechaInicio, Date fechaFin, E_tipoOperacion condCompra, int nroFactura, Estado estado, boolean conFecha) {
