...
public class Crear_producto_proveedor extends JDialog implements ActionListener, KeyListener, MouseListener {
    ...
    public void displayQueryResults() {
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                 ...
                 */
                jtProducto.setModel(DB_Producto.consultaSimpleProducto(desc, proveedor, marca, rubro, impuesto, estado, "Descripción", "Todos"));
                Utilities.c_packColumn.packColumns(jtProducto, 1);
            }
        });
    }
    ...
    public void recibirProveedor(M_proveedor proveedor) {
        ...
        this.jtProveedor.setModel(DB_Producto.consultaSimpleProducto("", this.proveedor.getEntidad(), "Todos", "Todos", "Todos", "Todos", "Descripción", "Todos"));
