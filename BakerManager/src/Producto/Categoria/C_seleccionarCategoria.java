 ...
 * @author Ramiro
 */
public class C_seleccionarCategoria extends javax.swing.JDialog implements ActionListener, MouseListener, KeyListener {
    ...
    public C_seleccionarCategoria(C_inicio c_inicio) {
    ...
    C_seleccionarCategoria(C_inicio c_inicio, C_gestion_producto aThis) {
        super(c_inicio.vista, true);
