 ...
 * @author Ramiro
 */
public class CompraBoletaPrintable implements Printable {
    ...
    public int print(Graphics g, PageFormat pf, int pi) throws PrinterException {
        ...
        if (facturaCabecera.getProveedor().getRuc() != null) {
            if (facturaCabecera.getProveedor().getRuc_id() != null) {
                rucAux = facturaCabecera.getProveedor().getRuc() + "-" + facturaCabecera.getProveedor().getRuc_id();
            }
        }
        ...
        if (pi == 0) {
            for (M_campoImpresion object : campoImpresiones) {
                ...
                if (object.getCampo().equals(MyConstants.NRO_BOLETA)) {
                    g.drawString("Nro boleta: " + facturaCabecera.getId_cabecera(), posX, posY);
                    if (preferencia.getIdDuplicado() == 1) {
                        int duplicadoDist = posY + preferencia.getDistanceBetweenCopies();
                        g.drawString("Nro boleta: " + facturaCabecera.getId_cabecera(), posX, duplicadoDist);
                    }
                    if (preferencia.getIdTriplicado() == 1) {
                        int triplicadoDist = posY + preferencia.getDistanceBetweenCopies() + preferencia.getDistanceBetweenCopies();
                        g.drawString("Nro boleta: " + facturaCabecera.getId_cabecera(), posX, triplicadoDist);
                    }
                }
                /*
                ...
                if (object.getCampo().equals(MyConstants.BOLETA_COND_VENTA_CONTADO)) {
                    if (facturaCabecera.getId_condVenta() == TipoOperacion.CONTADO) {
                ...
                if (object.getCampo().equals(MyConstants.BOLETA_COND_VENTA_CREDITO)) {
                    if (facturaCabecera.getId_condVenta() == TipoOperacion.CREDITO) {
                ...
                if (object.getCampo().equals(MyConstants.BOLETA_RAZON_SOCIAL)) {
                    g.drawString(MyConstants.BOLETA_RAZON_SOCIAL + ": " + facturaCabecera.getProveedor().getEntidad(), posX, posY);
                    if (preferencia.getIdDuplicado() == 1) {
                        int duplicadoDist = posY + preferencia.getDistanceBetweenCopies();
                        g.drawString(MyConstants.BOLETA_RAZON_SOCIAL + ": " + facturaCabecera.getProveedor().getEntidad(), posX, duplicadoDist);
                    }
                    if (preferencia.getIdTriplicado() == 1) {
                        int triplicadoDist = posY + preferencia.getDistanceBetweenCopies() + preferencia.getDistanceBetweenCopies();
                        g.drawString(MyConstants.BOLETA_RAZON_SOCIAL + ": " + facturaCabecera.getProveedor().getEntidad(), posX, triplicadoDist);
                    }
                }
                /*
                R.U.C.
                ...
                if (object.getCampo().equals(MyConstants.BOLETA_DIRECCION)) {
                    String dir = "";
                    if (facturaCabecera.getProveedor().getDireccion() != null) {
                        dir = facturaCabecera.getProveedor().getDireccion();
                    }
                ...
                if (object.getCampo().equals(MyConstants.BOLETA_DET_CANT_PROD)) {
                    for (M_egreso_detalle fd : facturaDetalle) {
