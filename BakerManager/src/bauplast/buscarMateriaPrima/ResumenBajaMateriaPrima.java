 ...
 */
public class ResumenBajaMateriaPrima extends JDialog implements ActionListener, KeyListener, InterfaceFacturaDetalle {
    ...
    public ResumenBajaMateriaPrima(JDialog frame, MateriaPrimaBajaTableModel tm2) {
        super(frame, DEFAULT_MODALITY_TYPE);
        setTitle("Resumen de baja de materias primas");
        setSize(800, 600);
