...
public class M_seleccionarFilm {
    ...
    public void consultarRollos(String descripcion, String buscarPor, String ordenarPor) {
        this.tm.setList(DB_Produccion.consultarFilmDisponible(descripcion, buscarPor, ordenarPor));
    }
}
