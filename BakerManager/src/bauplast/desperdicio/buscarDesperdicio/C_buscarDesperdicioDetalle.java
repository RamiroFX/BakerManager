 ...
 */
public class C_buscarDesperdicioDetalle extends MouseAdapter implements ActionListener, KeyListener {
    ...
    public C_buscarDesperdicioDetalle(M_buscarDesperdicioDetalle modelo, V_buscarDesperdicioDetalle vista) {
        this.vista = vista;
        this.modelo = modelo;
        inicializarVista();
        agregarListeners();
