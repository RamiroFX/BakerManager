 ...
 */
public class C_buscarProductosTerminados extends MouseAdapter implements ActionListener, KeyListener {
    ...
    public C_buscarProductosTerminados(M_buscarProductosTerminados modelo, V_buscarProductosTerminados vista) {
        this.vista = vista;
        this.modelo = modelo;
        inicializarVista();
        agregarListeners();
    ...
    public void displayQueryResults() {
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                modelo.consultarProductosTerminados(desc.toLowerCase(), buscarPor, ordenarPor, clasificarPor, categoria, porFecha, fechaInicio, fechaFinal);
