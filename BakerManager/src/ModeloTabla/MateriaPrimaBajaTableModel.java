 ...
 */
public class MateriaPrimaBajaTableModel extends AbstractTableModel {

    private DecimalFormat decimalFormat;
    private SimpleDateFormat dateFormater;
    private List<E_produccionDesperdicioDetalle> list;
    private final String[] colNames = {"Fecha", "O.T.", "Código", "Producto", "Cantidad"};

    public MateriaPrimaBajaTableModel() {
